...
func NewTunnelsPage() (*TunnelsPage, error) {
	...
	fillerInfoLabel1.SetText(l18n.Sprintf("Welcome to WGSafe."))
	...
	fillerInfoLabel2.SetText(l18n.Sprintf("Official services are available only at my github"))
	...
	infoLabel.SetText(l18n.Sprintf("Welcome to WGSafe."))
	infoLabel2, err := walk.NewLabel(infoContainer)
	if err != nil {
		return nil, err
	}
	infoLabel2.SetText(l18n.Sprintf("Official services are available only at my github"))
