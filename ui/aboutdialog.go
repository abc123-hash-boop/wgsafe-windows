...
func runAboutDialog(owner walk.Form) error {
	...
	showingAboutDialog.SetTitle(l18n.Sprintf("About WGSafe"))
	...
	copyrightLbl.SetText("Copyright © 2015-2025 abc123-hash-boop.\nCopyright © 2025 WGSafe. WGSafe is based on WireGuard,\nchanges and modifications made by abc123-hash-boop on github. All Rights Reserved.")
